...
const main_profile_settings_container = document.getElementById(
...
if (value == "password") {
	...
	const create_acc_content_form_input_old = document.getElementsByClassName(
		"create-acc-content-form-input"
	)[0];
	const create_acc_content_form_input_new = document.getElementsByClassName(
		"create-acc-content-form-input"
	)[1];
	const create_acc_content_form_input_new_confirm =
		document.getElementsByClassName("create-acc-content-form-input")[2];
	const create_acc_empty_field = document.getElementById(
		"create-acc-empty-field"
	);
	const settings_create_acc_cancel_button = document.getElementsByClassName(
		"settings-create-acc-confirm-button"
	)[0];
	const settings_create_acc_save_button = document.getElementsByClassName(
		"settings-create-acc-confirm-button"
	)[1];

	function onPressListener() {
		settings_create_acc_save_button.style.backgroundColor =
			"rgb(55, 109, 247)";
		settings_create_acc_save_button.innerHTML = "Changing";

		if (
			create_acc_content_form_input_new.value == "" ||
			create_acc_content_form_input_old.value == "" ||
			create_acc_content_form_input_new_confirm.value == ""
		) {
		...
		if (userIsGood) {
			firebase.auth().onAuthStateChanged(function (user) {
				if (user) {
					...
					user.updatePassword(create_acc_content_form_input_new.value)
						.then(() => {
							create_acc_empty_field.innerHTML = "";
							swal(
								"Success",
	...
	const create_acc_content_form_input_email = document.getElementsByClassName(
		"create-acc-content-form-input"
	)[0];
	const create_acc_empty_field = document.getElementById(
		"create-acc-empty-field"
	...
	function onPressListener() {
		...
		if (userIsGood) {
			firebase.auth().onAuthStateChanged(function (user) {
				user.updateEmail(create_acc_content_form_input_email.value)
					.then(() => {
						create_acc_empty_field.innerHTML = "";
