...
var profile_settings_li_normal = document.getElementsByClassName(
	"profile-settings-li-normal"
)[1];
...
if (value == "Name") {
	...
	const profile_container_div = document.querySelector(
	...
	const name_settings_title = document.getElementsByClassName(
		"name-settings-title"
	)[0];
	name_settings_title.innerHTML += localStorage["clickedValue"];
	const create_acc_content_form_input_firstName =
		document.getElementsByClassName("create-acc-content-form-input")[0];
	const create_acc_content_form_input_lastName =
		document.getElementsByClassName("create-acc-content-form-input")[1];
	const create_acc_empty_field = document.getElementById(
		"create-acc-empty-field"
	);
	firebase.auth().onAuthStateChanged(function (user) {
		if (user) {
			// console.log(firebase.auth().currentUser)
	...
	// filling name
	const setting_create_acc_save_button = document.getElementsByClassName(
		"settings-create-acc-confirm-button"
	)[1];
	setting_create_acc_save_button.addEventListener("click", () => {
		setting_create_acc_save_button.innerHTML = "Changing...";
		setting_create_acc_save_button.style.backgroundColor =
			"rgb(55, 109, 247)";
		...
		fixed_firstName =
			fixed_firstName.charAt(0).toUpperCase() + fixed_firstName.slice(1);
		fixed_lastName =
			fixed_lastName.charAt(0).toUpperCase() + fixed_lastName.slice(1);
	...
	const setting_create_acc_cancel_button = document.getElementsByClassName(
		"settings-create-acc-confirm-button"
	)[0];
	...
	setting_create_acc_save_button.addEventListener("click", () => {
		const create_acc_content_form_date = document.getElementsByClassName(
			"create-acc-content-form-input-date"
		)[0];
		setting_create_acc_save_button.innerHTML = "Changing...";
		setting_create_acc_save_button.style.backgroundColor =
			"rgb(55, 109, 247)";
			...
			firebase
				...
				.catch((error) => {
					...
					create_acc_empty_field.innerHTML =
						"Network failed please try agin";
	...
	const gender_indicator_text_male = document.getElementsByClassName(
		"gender-indicator-checkbox"
	)[0];
	const gender_indicator_text_female = document.getElementsByClassName(
		"gender-indicator-checkbox"
	)[1];
	...
	setting_create_acc_save_button.addEventListener("click", () => {
		const create_acc_content_form_input_date =
	...
	auth.onAuthStateChanged(function (user) {
		if (user) {
			const create_acc_content_form_useremail =
				document.getElementsByClassName(
					"create-acc-content-form-user-email"
				)[0];
			create_acc_content_form_useremail.innerHTML =
				auth.currentUser.email;
		}
	});

	const create_acc_content_recoveryemail = document.getElementsByClassName(
		"create-acc-content-recoveryemail"
	)[0];
	...
	const create_acc_content_form_input = document.getElementsByClassName(
		"create-acc-content-form-input"
	)[0];
	const setting_create_acc_save_button = document.getElementsByClassName(
		"settings-create-acc-confirm-button"
	)[1];
	setting_create_acc_save_button.addEventListener("click", () => {
		...
		if (
			create_acc_content_form_input.value[1].toString() != "9" &&
			create_acc_content_form_input.value[1].toString() != "1"
		) {
			create_acc_empty_field.innerHTML = "Invalid phone number";
			setting_create_acc_save_button.innerHTML = "Save";
			setting_create_acc_save_button.style.backgroundColor =
...
const name_settings_title_icon = document.getElementById(
	"name-settings-title-icon"
);
